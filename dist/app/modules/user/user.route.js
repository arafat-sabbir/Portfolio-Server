...
// Register A New User
router.post('/register', (0, validateRequest_1.default)(user_validation_1.userValidation.createUserSchema), user_controller_1.userControllers.createUser);
//Login User
router.post('/login', (0, validateRequest_1.default)(user_validation_1.userValidation.loginUserSchema), user_controller_1.userControllers.loginUser);
